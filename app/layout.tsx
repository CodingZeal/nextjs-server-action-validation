      ...
      <body>
        <main className="flex flex-col items-center w-full">
          <nav className="bg-green-400 p-4 flex justify-between items-center w-full">
            <a className="text-black font-bold text-2xl tracking-wide" href="/">
              mister deejay
            </a>
          ...
          <section className="w-full max-w-7xl px-4 py-8">{children}</section>
        </main>
        <footer className="absolute bottom-0 w-full py-8 px-4">
          <div className="flex flex-col items-center md:flex-row md:justify-center">
            ...
            <small>
              <a
                href="https://github.com/CodingZeal/nextjs-server-action-validation"
                target="_blank"
                className="text-sm text-green-700 underline font-semibold hover:no-underline"
              >
                Source Code
              </a>
            </small>
